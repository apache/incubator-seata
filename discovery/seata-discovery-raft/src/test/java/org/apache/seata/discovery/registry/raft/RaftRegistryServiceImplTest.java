...
class RaftRegistryServiceImplTest {
    ...
    public void testLoginFailed() throws IOException, NoSuchMethodException {
        ...
        try (MockedStatic<Http1HttpExecutor> mockedStatic = Mockito.mockStatic(Http1HttpExecutor.class)) {
            ...
            when(Http1HttpExecutor.doPost(any(String.class), any(Map.class), any(Map.class), any(int.class)))
