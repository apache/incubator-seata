...
public class ConsulRegistryServiceImpl implements RegistryService<ConsulListener> {
	...
	private String getClusterName() {
		String clusterConfigName = String.join(FILE_CONFIG_SPLIT_CHAR, FILE_ROOT_REGISTRY, REGISTRY_TYPE,
				REGISTRY_CLUSTER);
	...
	private void refreshCluster(String cluster, List<HealthService> services) {
		...
		clusterAddressMap.put(cluster,
				services.stream().map(HealthService::getService)
