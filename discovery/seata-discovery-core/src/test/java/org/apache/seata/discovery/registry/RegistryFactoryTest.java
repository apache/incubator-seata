...
public class RegistryFactoryTest {
    @Test
    public void testRegistryFactory() throws Exception {
        ...
        when(mockConfig.getConfig("registry.type")).thenReturn("aaa");
        try {
            ...
            assertEquals("not support registry type: aaa", error.getCause().getMessage());
        } finally {
