...
import io.seata.integration.dubbo3.mock.MockInvoker;
 ...
 * @author wang.liang
 */
public class ApacheDubbo3TransactionPropagationBaseFilterTest {

    private static final String DEFAULT_XID = "1234567890";

    @Test
    public void testInvoke_And_RootContext() {
        ApacheDubbo3TransactionPropagationBaseFilter filter = new ApacheDubbo3TransactionPropagationBaseFilter();
