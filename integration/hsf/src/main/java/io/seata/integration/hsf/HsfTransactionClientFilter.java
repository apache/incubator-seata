...
/**
 * hsf Transaction propagation filter client side.
 *
 * @author slievrly
 */
public class HsfTransactionClientFilter implements ClientFilter {

    private static final Logger LOGGER = LoggerFactory.getLogger(HsfTransactionClientFilter.class);
    ...
    public ListenableFuture<RPCResult> invoke(InvocationHandler invocationHandler, Invocation invocation)
        ...
        if (LOGGER.isDebugEnabled()) {
            LOGGER.debug("xid in RootContext[{}] in client.RpcContext[{}]", xid);
        }
