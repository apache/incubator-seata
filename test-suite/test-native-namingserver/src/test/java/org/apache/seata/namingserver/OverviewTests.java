...
/**
 * Tests for Namingserver overview API.
 *
 * <p>Verifies the overview endpoint
 * {@code GET /api/v1/overview/getData}
 * from the console module. This endpoint returns overview data.
 *
...
class OverviewTests {
    ...
    /**
     * Namingserver overview endpoint URL.
     */
    String url = "http://127.0.0.1:8081/api/v1/overview/getData";

    /**
     * Test querying overview data.
     *
     * <p>Expects a success response with non-null data containing overview information.
     */
    @Test
    void overviewSuccess() {
        ...
        SingleResult singleResult = restTemplate.execute(url, HttpMethod.GET, requestCallback, responseExtractor);
        assertNotNull(singleResult);
        assertEquals(Result.SUCCESS_CODE, singleResult.getCode());
        assertEquals(Result.SUCCESS_MSG, singleResult.getMessage());
        assertNotNull(singleResult.getData());
