...
/**
 * Tests for Namingserver namespace v1 API.
 *
 * <p>Verifies the namespace v1 endpoint
 * {@code GET /api/v1/naming/namespace}
 * for listing all namespaces with their clusters and vgroups.
 *
...
class NamespaceV1Tests {
    ...
    /**
     * Test querying namespaces in v1 format.
     *
     * <p>Expects a success response with non-null data.
     */
    @Test
    void namespaceV1Success() {
