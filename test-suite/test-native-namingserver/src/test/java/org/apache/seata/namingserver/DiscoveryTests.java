...
/**
 * Tests for Namingserver discovery API.
 *
 * <p>Verifies the discovery endpoint
 * {@code GET /api/v1/naming/discovery}
 * for discovering cluster addresses by transaction group (vgroup).
 *
...
class DiscoveryTests {
    ...
    /**
     * Test discovery by vgroup.
     *
     * <p>Expects a non-null response with cluster list.
     */
    @Test
    void discoverySuccess() {
        ...
        uriVariables.put("vGroup", "default");
        ...
        HttpMessageConverterExtractor<Map> responseExtractor =
                new HttpMessageConverterExtractor<>(Map.class, restTemplate.getMessageConverters());
        Map<?, ?> result = restTemplate.execute(url, HttpMethod.GET, requestCallback, responseExtractor, uriVariables);
