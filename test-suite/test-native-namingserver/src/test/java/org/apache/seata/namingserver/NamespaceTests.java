...
/**
 * Tests for Namingserver namespace API.
 *
 * <p>Verifies the namespace query endpoint
 * {@code GET /api/v2/naming/namespace}
...
class NamespaceTests {
    ...
    /**
     * Namingserver namespace query endpoint URL.
     */
    String url = "http://127.0.0.1:8081/api/v2/naming/namespace";

    /**
     * Test querying namespaces with valid authentication.
     *
     * <p>Expects a success response with non-null data.
     */
    @Test
    void namespaceSuccess() {
