...
import org.apache.seata.spring.boot.autoconfigure.properties.server.filter.ServerHttpFiltersProperties;
import org.apache.seata.spring.boot.autoconfigure.properties.server.filter.ServerHttpXSSFilterProperties;
...
public class SeataServerEnvironmentPostProcessor implements EnvironmentPostProcessor, Ordered {
    ...
    public static void init() {
        if (INIT.compareAndSet(false, true)) {
            ...
            PROPERTY_BEAN_MAP.put(SERVER_HTTP_FILTER_PREFIX, ServerHttpFiltersProperties.class);
            PROPERTY_BEAN_MAP.put(SERVER_HTTP_FILTER_XSS_PREFIX, ServerHttpXSSFilterProperties.class);
        }
    }
}
