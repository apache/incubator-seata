...
此版本更新如下：
  ...
  - [[#2933](https://github.com/seata/seata/pull/2933)] 增加可选使用Antlr解析MYSQL语法功能  
  - [[#3228](https://github.com/seata/seata/pull/3228)] 增加插件模块
  ...
  - [[#3464](https://github.com/seata/seata/pull/3464)] 修复单元测试空指针问题以及StackTraceLogger日志
  - [[#3402](https://github.com/seata/seata/pull/3402)] 修复特定情况下无法获取更新的字段名
  ...
  - [[#3459](https://github.com/seata/seata/pull/3459)] 移除NacosRegistryServiceImpl类中重复的validAddress方法
  - [[#3212](https://github.com/seata/seata/pull/3212)] 优化解析OrderBy，Limit条件代码结构
  - [[#3371](https://github.com/seata/seata/pull/3371)] 监控指标增加applicationId属性
  - [[#3318](https://github.com/seata/seata/pull/3318)] 开放CLIENT_TABLE_META_CHECKER_INTERVAL配置
  - [[#3523](https://github.com/seata/seata/pull/3523)] 优化Oracle释放保存点逻辑
  - [[#3513](https://github.com/seata/seata/pull/3513)] 优化SagaJSON解析器
