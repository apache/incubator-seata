...
此版本更新如下：
  ...
  - [[#3317](https://github.com/seata/seata/pull/3317)] 添加从zookeeper单一node获取多条配置功能
  - [[#2933](https://github.com/seata/seata/pull/2933)] 为mysql sqlparser添加antlr
  - [[#3228](https://github.com/seata/seata/pull/3228)] 添加 seata plugin. 比如:seata jackson parser oracle.
  - [[#3516](https://github.com/seata/seata/pull/3516)] 为consul添加acl-token
  ...
  - [[#3522](https://github.com/seata/seata/pull/3522)] 当AT分支不需要竞争锁时注册分支和存undolog
  ...
  - [[#3215](https://github.com/seata/seata/pull/3215)] 在文件模式下启动时选择重新加载
