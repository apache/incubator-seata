...
- [[4448](https://github.com/seata/seata/pull/4448)] optimize When the Seata client and server adopt Nacos as the registry, the client will subscribe to the Seata server and the application name will be unknown
