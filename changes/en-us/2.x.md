...
### feature:
- [[#7599](https://github.com/apache/incubator-seata/pull/7485)] When NettyClientBootstrap.getNewChannel catches an exception, if it is already a FrameworkException, it will not be wrapped into a FrameworkException again; the error message contains the Server address, and it does not rely on the info log printed by the calling place;
