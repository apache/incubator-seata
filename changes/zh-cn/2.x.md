...
- [[#7599](https://github.com/apache/incubator-seata/pull/7485)] NettyClientBootstrap.getNewChannel 捕获异常时，如果已经是FrameworkException就不再重复包装成FrameworkException；报错时消息中包含Server地址，不依赖调用的地方打印的info日志；
