...
- [[#6545](https://github.com/apache/incubator-seata/pull/6545)] 修复TestConfigcustomSpi兼容性测试失败
- [[#6533](https://github.com/apache/incubator-seata/pull/6533)] 增加Integration-TX-API模块单元测试覆盖范围
