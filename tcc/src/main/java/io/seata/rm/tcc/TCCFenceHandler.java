...
public class TCCFenceHandler {
    ...
    public static Object prepareFence(String xid, Long branchId, String actionName, Callback<Object> targetCallback) {
        return transactionTemplate.execute(status -> {
            try {
                ...
                boolean result = insertTCCFenceLog(conn, xid, branchId, actionName, CommonFenceConstant.STATUS_TRIED);
    ...
    public static boolean commitFence(Method commitMethod, Object targetTCCBean,
        ...
        return transactionTemplate.execute(status -> {
            try {
                Connection conn = DataSourceUtils.getConnection(dataSource);
                CommonFenceDO tccFenceDO = TCC_FENCE_DAO.queryCommonFenceDO(conn, xid, branchId);
                if (tccFenceDO == null) {
                    throw new CommonFenceException(String.format("TCC fence record not exists, commit fence method failed. xid= %s, branchId= %s", xid, branchId),
    ...
    public static boolean rollbackFence(Method rollbackMethod, Object targetTCCBean,
        ...
        return transactionTemplate.execute(status -> {
            try {
                ...
                // non_rollback
                if (tccFenceDO == null) {
                    boolean result = insertTCCFenceLog(conn, xid, branchId, actionName, CommonFenceConstant.STATUS_SUSPENDED);
    ...
    public static boolean deleteFence(String xid, Long branchId) {
        return transactionTemplate.execute(status -> {
            ...
            try {
                Connection conn = DataSourceUtils.getConnection(dataSource);
                ret = TCC_FENCE_DAO.deleteCommonFenceDO(conn, xid, branchId);
