...
public abstract class AbstractConnectionProxy implements Connection {
    ...
    private volatile long lastAcquireTimeMillis = System.currentTimeMillis();
    ...
    /**
     * Marks the moment the connection was acquired
     */
    protected void markAcquireTime() {
        lastAcquireTimeMillis = System.currentTimeMillis();
    }

    /**
     * Computes how long the connection has been held since last acquisition
     *
     * @return hold duration in milliseconds
     */
    public long calcHoldTimeMillis() {
        return System.currentTimeMillis() - lastAcquireTimeMillis;
    }

    @Override
    public Statement createStatement() throws SQLException {
        // record acquisition timestamp
        this.markAcquireTime();
