...
public class TableMetaCache {
    ...
    public static TableMeta getTableMeta(List<String> sqlHints, String tableName, DataSourceProxy dataSourceProxy) {
        ...
        return getTableMeta(dataSourceProxy.getTargetDataSource(), tableName, cacheKey, metaQuerySql);
    }


    public static TableMeta getTableMeta(final DruidDataSource druidDataSource, final String tableName, final String cacheKey, final String metaQuerySql) {
        ...
        try {
            tmeta = TABLE_META_CACHE.get(cacheKey, new Callable<TableMeta>() {
                ...
                public TableMeta call() throws Exception {
                    return fetchSchemeInDefaultWay(druidDataSource, tableName, metaQuerySql);
                }
            });
        ...
        if (tmeta == null) {
            try {
                tmeta = fetchSchemeInDefaultWay(druidDataSource, tableName, metaQuerySql);
    ...
    private static TableMeta fetchSchemeInDefaultWay(DruidDataSource druidDataSource, String tableName, String querySql) throws SQLException {
