...
public class H2TableMetaCache extends AbstractTableMetaCache {

    private static final Logger LOGGER = LoggerFactory.getLogger(H2TableMetaCache.class);
    ...
    protected TableMeta fetchSchema(Connection connection, String tableName) throws SQLException {
        String sql = "SELECT * FROM " + ColumnUtils.addEscape(tableName, JdbcConstants.H2) + " LIMIT 1";
        ...
        try (ResultSet rsColumns = dbmd.getColumns(catalogName, schemaName, tableName, "%");
            ...
            while (rsIndex.next()) {
                ...
                if (tm.getAllIndexes().containsKey(indexName)) {
                    ...
                    index.getValues().add(col);
                    if (StringUtils.isNotBlank(indexName) && indexName.toUpperCase().startsWith("PRIMARY_KEY")) {
