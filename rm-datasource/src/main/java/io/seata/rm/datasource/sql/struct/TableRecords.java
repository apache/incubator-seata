...
import static io.seata.rm.datasource.util.OffsetTimeUtils.TIMESTAMP_WITH_LOCAL_TIME_ZONE;
import static io.seata.rm.datasource.util.OffsetTimeUtils.TIMESTAMP_WITH_TIME_ZONE;
        ...
        while (resultSet.next()) {
            ...
            for (int i = 1; i <= columnCount; i++) {
                ...
                if (dataType == Types.BLOB) {
                    ...
                    field.setValue(String.valueOf(resultSet.getObject(i)));
