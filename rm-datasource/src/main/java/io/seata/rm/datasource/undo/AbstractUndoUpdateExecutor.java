 ...
 * @author chd
 */
public class AbstractUndoUpdateExecutor extends AbstractUndoExecutor {
     ...
     */
    public AbstractUndoUpdateExecutor(SQLUndoLog sqlUndoLog) {
        super(sqlUndoLog);
    }
    ...
    public void executeOn(Connection conn) throws SQLException {
        ...
        try {
            ...
            List<List<Row>> rowsDouble = Lists.partition(undoRows.getRows(), UPDATE_BATCH_NUM);
