...
public class JavaSqlClobToStringSerializer extends StdSerializer<Object> {
    ...
    /**
     * <p> Note: usually you should NOT create new instances, but instead use {@link #INSTANCE} which is stateless and
     * fully thread-safe. However, there are cases where constructor is needed; for example, when using explicit
     * serializer annotations like {@link com.fasterxml.jackson.databind.annotation.JsonSerialize#using}.
     */
    public JavaSqlClobToStringSerializer() {
        super(Object.class);
    }
