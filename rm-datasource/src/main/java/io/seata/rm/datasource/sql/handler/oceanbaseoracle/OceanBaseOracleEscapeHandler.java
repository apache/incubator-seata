 ...
 */
package io.seata.rm.datasource.sql.handler.oceanbaseoracle;
...
public class OceanBaseOracleEscapeHandler implements EscapeHandler {

    private Set<String> keywordSet = Arrays.stream(OceanBaseOracleKeyword.values()).map(OceanBaseOracleKeyword::name).collect(Collectors.toSet());

    /**
     * oracle keyword
     */
    private enum OceanBaseOracleKeyword {
        /**
        ...
        OceanBaseOracleKeyword(String name) {
            this.name = name;
        }
    }
