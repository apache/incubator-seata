...
public class MySQLInsertExecutorTest {
    ...
    @Test
    public void test_autoGeneratePks() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException, NoSuchFieldException {
        MySQLDataSourceProxyMetadata dataSourceProxyMetadata = (MySQLDataSourceProxyMetadata)
                insertExecutor.statementProxy.getConnectionProxy().getDataSourceProxy().getDataSourceProxyMetadata();
        Map<String, String> variables = new HashMap<>();
        variables.put("auto_increment_increment", "1");
        Field variablesField = dataSourceProxyMetadata.getClass().getDeclaredField("variables");
        variablesField.setAccessible(true);
        variablesField.set(dataSourceProxyMetadata, variables);
