 ...
 * @date 2021-10-25
 */
public class DB2UndoInsertExecutorTest extends BaseExecutorTest {
    private static DB2UndoInsertExecutor executor;
    ...
    public static void init(){
        ...
        executor = new DB2UndoInsertExecutor(sqlUndoLog);
    }
