 ...
 * @date 2021-10-25
 */
public class DB2UndoUpdateExecutorTest extends BaseExecutorTest {
    private static DB2UndoUpdateExecutor executor;
    ...
    public static void init(){
        ...
        executor = new DB2UndoUpdateExecutor(sqlUndoLog);
    }
