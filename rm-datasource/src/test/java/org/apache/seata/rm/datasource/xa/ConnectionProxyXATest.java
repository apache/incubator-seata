...
public class ConnectionProxyXATest {
    ...
    public void testConstructor() {
        ...
        Assertions.assertSame(mockConnection, connectionProxyXA.getWrappedConnection(), 
            "Should correctly wrap the original connection");
        Assertions.assertSame(mockXAConnection, connectionProxyXA.getWrappedXAConnection(), 
    ...
    public void testInitSuccess() throws SQLException {
        ...
        Assertions.assertDoesNotThrow(() -> connectionProxyXA.init(), 
            "Init should succeed when autocommit=true");
    ...
    public void testInitFailsWithSQLException() throws SQLException {
        ...
        Assertions.assertThrows(RuntimeException.class, connectionProxyXA::init,
    ...
    public void testGetAutoCommit() throws SQLException, TransactionException {
        ...
        when(mockResourceManager.branchRegister(eq(BranchType.XA), anyString(), eq(null), eq("test-autocommit"), eq(null), eq(null)))
                .thenReturn(123L);
        connectionProxyXA.setAutoCommit(false);
        Assertions.assertFalse(connectionProxyXA.getAutoCommit(), 
            "getAutoCommit should return false after setAutoCommit(false)");
    }
    ...
    public void testSetAutoCommitFromTrueToFalse() throws Exception {
        ...
        when(mockResourceManager.branchRegister(eq(BranchType.XA), anyString(), eq(null), eq("test-xa-start"), eq(null), eq(null)))
                .thenReturn(123L);
        ...
        Mockito.verify(mockResourceManager).branchRegister(eq(BranchType.XA),eq(null), eq(null), eq("test-xa-start"), eq(null), eq(null));
    ...
    public void testSetAutoCommitXAStartFails() throws Exception {
        ...
        Assertions.assertTrue(exception.getMessage().contains("failed to start xa branch"),
    ...
    public void testCommitOnAutoCommitSession() throws SQLException, XAException {
        ...
        Assertions.assertDoesNotThrow(() -> connectionProxyXA.commit(),
            "Commit on autocommit session should be ignored");
    ...
    public void testRollbackOnAutoCommitSession() throws SQLException, XAException {
        ...
        // Should not throw exception and should be ignored
        Assertions.assertDoesNotThrow(() -> connectionProxyXA.rollback(),
            "Rollback on autocommit session should be ignored");
    ...
    public void testShouldBeHeld() throws SQLException {
        ...
        ConnectionProxyXA connectionProxyXA1 = 
                new ConnectionProxyXA(mockConnection, mockXAConnection, mockDataSourceResource, xid);
        Assertions.assertTrue(connectionProxyXA1.shouldBeHeld(), 
            "Should be held when resource indicates so");
        ...
        ConnectionProxyXA connectionProxyXA2 = 
                new ConnectionProxyXA(mockConnection, mockXAConnection, mockDataSourceResource, xid);
        Assertions.assertTrue(connectionProxyXA2.shouldBeHeld(), 
            "Should be held when DB type is blank");
        ...
        ConnectionProxyXA connectionProxyXA3 = 
                new ConnectionProxyXA(mockConnection, mockXAConnection, mockDataSourceResource, xid);
        Assertions.assertFalse(connectionProxyXA3.shouldBeHeld(), 
    ...
    public void testGetAndSetPrepareTime() throws SQLException {
        ...
        Assertions.assertNull(connectionProxyXA.getPrepareTime(), 
            "Prepare time should be null initially");
    }
    ...
    public void testSetCombine() throws SQLException {
        ...
        Assertions.assertDoesNotThrow(() -> connectionProxyXA.rollback(),
            "Rollback should return early in combine mode");
        
        // Test that close returns early in combine mode
        Assertions.assertDoesNotThrow(() -> connectionProxyXA.close(),
            "Close should return early in combine mode");
    }
    ...
    public void testCreatePreparedStatement() throws SQLException {
        ...
        Assertions.assertTrue(statement instanceof PreparedStatementProxyXA,
            "Should return PreparedStatementProxyXA instance");
    }
    ...
    public void testXACommitWithResourceLock() throws Exception {
        ...
        Assertions.assertDoesNotThrow(() -> connectionProxyXA.xaCommit(xid, branchId, null),
    ...
    public void testXARollbackWithResourceLock() throws Exception {
        ...
        // Should not throw exception
        Assertions.assertDoesNotThrow(() -> connectionProxyXA.xaRollback(xid, branchId, null),
    ...
    public void testCloseWithXAReadOnly() throws Exception {
        ...
        Assertions.assertDoesNotThrow(() -> connectionProxyXA.close(),
            "Close should handle XA_RDONLY properly");
        
        // Verify prepare was called
        Mockito.verify(mockXAResource).prepare(any(Xid.class));
        // Verify branch report was called with RDONLY status
        Mockito.verify(mockResourceManager).branchReport(eq(BranchType.XA), eq(xid), anyLong(), eq(BranchStatus.PhaseOne_RDONLY), any());
    }
    ...
    public void testCloseWithXAException() throws Exception {
        ...
        Assertions.assertTrue(exception.getMessage().contains("Failed to end(TMSUCCESS)/prepare xa branch"),
            "Exception message should indicate XA failure");
        
        // Verify branch report was called with Failed status
        Mockito.verify(mockResourceManager).branchReport(eq(BranchType.XA), eq(xid), anyLong(), eq(BranchStatus.PhaseOne_Failed), any());
    }
