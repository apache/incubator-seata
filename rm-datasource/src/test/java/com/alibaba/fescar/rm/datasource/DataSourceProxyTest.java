...
public class DataSourceProxyTest {
    ...
    public void before() throws SQLException {
        Mockito.when(dataSource.getConnection()).thenReturn(new CustomMockConnection());
    }


    @Test
    public void testRetryTimesSetting() {
    ...
    private class CustomMockConnection extends com.alibaba.druid.mock.MockConnection {
        @Override
