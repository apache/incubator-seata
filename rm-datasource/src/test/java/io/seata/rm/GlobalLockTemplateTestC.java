...
/**
 * Compared with {@link GlobalLockTemplateTest},
 * test compatibility of {@link GlobalLockConfig#getLockRetryInterval()}
 * and {@link GlobalLockConfig#getLockRetryInternal()},
 * the former takes precedence over the latter.
 *
 * @author linkedme@qq.com
 */
public class GlobalLockTemplateTestC {
    ...
    private GlobalLockConfig generateGlobalLockConfig() {
        ...
        config.setLockRetryInterval(200);
