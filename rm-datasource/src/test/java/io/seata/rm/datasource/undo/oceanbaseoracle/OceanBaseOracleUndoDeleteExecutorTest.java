...
/**
 * Test cases for undo-delete executor of OceanBaseOracle
 *
 * @author hsien999
 */
public class OceanBaseOracleUndoDeleteExecutorTest extends BaseExecutorTest {
    private static OceanBaseOracleUndoDeleteExecutor EXECUTOR;
    ...
    public static void init() {
        ...
        EXECUTOR = new OceanBaseOracleUndoDeleteExecutor(sqlUndoLog);
    }
    ...
    public void testBuildUndoSQL() {
        ...
        Assertions.assertTrue(sql.contains(AGE_NAME));
        Assertions.assertTrue(sql.contains(ID_NAME));
        Assertions.assertEquals("INSERT INTO TABLE_NAME (AGE, ID) VALUES (?, ?)", sql.toUpperCase());
    }
