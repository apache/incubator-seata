...
/**
 * Test cases for cache holder of OceanBase table mata
 *
 * @author hsien999
 */
public class OceanBaseOracleTableMetaCacheTest {
    private static final Object[][] columnMetas =
        new Object[][]{
    ...
    private static final Object[][] indexMetas =
        new Object[][]{
    ...
    private TableMetaCache getTableMetaCache() {
        return TableMetaCacheFactory.getTableMetaCache(JdbcConstants.OCEANBASE_ORACLE);
    }

    @Test
    public void testGetTableMetaWithNull() {
    ...
    public void testGetTableMeta() throws SQLException {
        ...
        // test throws
        mockDriver.setMockIndexMetasReturnValue(new Object[][]{});
