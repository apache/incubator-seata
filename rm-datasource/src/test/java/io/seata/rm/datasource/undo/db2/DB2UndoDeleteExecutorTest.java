 ...
 * @date 2021-10-25
 */
public class DB2UndoDeleteExecutorTest extends BaseExecutorTest {
    private static DB2UndoDeleteExecutor executor;
    ...
    public static void init() {
        ...
        executor = new DB2UndoDeleteExecutor(sqlUndoLog);
    }
