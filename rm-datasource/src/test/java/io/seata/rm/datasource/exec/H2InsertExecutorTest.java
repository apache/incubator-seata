...
import io.seata.rm.datasource.exec.h2.H2InsertExecutor;
 ...
 * @author hongyan
 */
public class H2InsertExecutorTest {
    ...
    private H2InsertExecutor insertExecutor;
    ...
    public void init() {
        ...
        when(connectionProxy.getDbType()).thenReturn(JdbcConstants.H2);
        ...
        insertExecutor = Mockito.spy(new H2InsertExecutor(statementProxy, statementCallback, sqlInsertRecognizer));
