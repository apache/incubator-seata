...
public class InsertBySelectExecutorTest {
    protected static BaseInsertExecutor insertExecutor;
    protected static StatementProxy statementProxy;
    protected static SQLInsertRecognizer insertRecognizer;
    ...
    public static void init() {
        ...
        insertRecognizer = mock(MySQLInsertRecognizer.class);
        insertExecutor = Mockito.spy(new InsertBySelectExecutor(statementProxy, (statement, args) -> {
            return null;
        }, insertRecognizer));
    }
