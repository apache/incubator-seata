...
public class SpringCloudConfigurationSourceProvider implements ConfigurationSourceProvider {
    @Override
    public void provide(Configuration configuration) {
        configuration.addSourceLast(SpringCloudConfigurationSource.getInstance());
    }
}
