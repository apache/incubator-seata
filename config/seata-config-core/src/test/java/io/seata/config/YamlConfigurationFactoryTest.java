...
class YamlConfigurationFactoryTest {
    ...
    public void getInstance() {
        ...
        Assertions.assertEquals(ConfigurationFactory.CURRENT_FILE_INSTANCE.getString("config.file.name"), "file-test-yaml.conf");
        Assertions.assertEquals(ConfigurationFactory.CURRENT_FILE_INSTANCE.getString("config.file.testBlank"), "");
        Assertions.assertEquals(ConfigurationFactory.CURRENT_FILE_INSTANCE.getString("config.file.testNull"), null);
        Assertions.assertEquals(ConfigurationFactory.CURRENT_FILE_INSTANCE.getString("config.file.testExist"), null);
