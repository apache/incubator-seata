...
import static io.seata.config.source.ConfigSourceOrdered.DEFAULT_CONF_SOURCE_PROVIDER_ORDER;

/**
 * The type Registry and file default value configuration source provider.
 *
 * @author wang.liang
 */
@LoadLevel(name = "default-conf-file", order = DEFAULT_CONF_SOURCE_PROVIDER_ORDER)
