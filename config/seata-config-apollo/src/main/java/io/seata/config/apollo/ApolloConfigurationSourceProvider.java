 ...
 */
@LoadLevel(name = "Apollo", order = CONFIG_CENTER_SOURCE_ORDER)
public class ApolloConfigurationSourceProvider implements ConfigurationSourceProvider {
    @Override
    public void provide(Configuration configuration) {
        configuration.addSourceLast(ApolloConfigurationSource.getInstance());
    }
}
