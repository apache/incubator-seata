...
/**
 * The type Consul configuration source.
 *
 * @author xingfudeshi @gmail.com
 */
public class ConsulConfigurationSource implements RemoteConfigurationSource
        , UpdatableConfiguration, ConfigListenerManager {
    private volatile static ConsulConfigurationSource instance;
    private volatile static ConsulClient client;

    private static final Logger LOGGER = LoggerFactory.getLogger(ConsulConfigurationSource.class);
    ...
    private ConsulConfigurationSource() {
     ...
     * @return instance
     */
    public static ConsulConfigurationSource getInstance() {
        if (instance == null) {
            synchronized (ConsulConfigurationSource.class) {
                if (instance == null) {
                    instance = new ConsulConfigurationSource();
                }
            }
        }
        return instance;
