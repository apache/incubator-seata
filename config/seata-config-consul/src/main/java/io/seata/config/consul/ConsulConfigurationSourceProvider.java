 ...
 */
@LoadLevel(name = "Consul", order = CONFIG_CENTER_SOURCE_ORDER)
public class ConsulConfigurationSourceProvider implements ConfigurationSourceProvider {
    @Override
    public void provide(Configuration configuration) {
        configuration.addSourceLast(ConsulConfigurationSource.getInstance());
    }
}
