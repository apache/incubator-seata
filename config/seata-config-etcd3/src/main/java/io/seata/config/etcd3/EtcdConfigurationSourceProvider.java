 ...
 */
@LoadLevel(name = "Etcd3", order = CONFIG_CENTER_SOURCE_ORDER)
public class EtcdConfigurationSourceProvider implements ConfigurationSourceProvider {
    @Override
    public void provide(Configuration configuration) {
        configuration.addSourceLast(EtcdConfigurationSource.getInstance());
    }
}
