...
/**
 * The type Etcd configuration source.
 *
 * @author xingfudeshi @gmail.com
 */
public class EtcdConfigurationSource implements RemoteConfigurationSource
    ...
    private static volatile EtcdConfigurationSource instance;
     ...
     * @return instance
     */
    public static EtcdConfigurationSource getInstance() {
        if (instance == null) {
            synchronized (EtcdConfigurationSource.class) {
                if (instance == null) {
                    instance = new EtcdConfigurationSource();
                }
            }
        }
        return instance;
    ...
    private static Client getClient() {
        if (client == null) {
            synchronized (EtcdConfigurationSource.class) {
                if (client == null) {
                    client = Client.builder().endpoints(ConfigurationFactory.getInstance().getString(FILE_CONFIG_KEY_PREFIX + SERVER_ADDR_KEY))
                        .build();
                }
            }
        }
