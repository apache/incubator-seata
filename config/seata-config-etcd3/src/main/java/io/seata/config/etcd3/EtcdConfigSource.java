...
public class EtcdConfigSource implements RemoteConfigSource
     ...
     * @return instance
     */
    public static EtcdConfigSource getInstance() {
        if (instance == null) {
            synchronized (EtcdConfigSource.class) {
                if (instance == null) {
                    instance = new EtcdConfigSource();
                }
            }
        }
        return instance;
    ...
    private static class EtcdListener implements ConfigurationChangeListener {
        ...
        private final EtcdConfigSource source;
         ...
         */
        public EtcdListener(String dataId, ConfigurationChangeListener listener, EtcdConfigSource source) {
            this.dataId = dataId;
