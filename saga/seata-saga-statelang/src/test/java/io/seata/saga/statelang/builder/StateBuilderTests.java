        ...
        StateMachine builtStateMachine = stateMachineBuilder
                ...
                .withStates()
                    ...
                    .build(ChoiceStateBuilder.class)
                        ...
                        .withChoice("foo == 3", "ThirdMatchState")
                    ...
                    .build(SubStateMachineBuilder.class)
                        ...
                        .withNext("SuccessState")
                        .and()
                    .build(ForkStateBuilder.class)
                        .withName("ThirdMatchState")
                        .withBranches(Arrays.asList("FirstParallel", "SecondParallel"))
                        .withTimeout(1000)
                        .withParallel(2)
                        .and()
                    .build(ServiceTaskStateBuilder.class)
                        .withName("FirstParallel")
                        .withNext("JoinState")
                        .and()
                    .build(ServiceTaskStateBuilder.class)
                        .withName("SecondParallel")
                        .withNext("JoinState")
                        .and()
                    .build(JoinStateBuilder.class)
                        .withName("JoinState")
                        .withNext("SuccessState")
                        .and()
                    .build(FailEndStateBuilder.class)
