...
public class DesignerJsonTransformer {
    ...
    public static Map<String, Object> toStandardJson(Map<String, Object> designerJsonObject) {
        ...
        if (CollectionUtils.isEmpty(nodes) || CollectionUtils.isEmpty(edges)) {
            throw new RuntimeException("Nodes or edges are empty, please check them.");
        }
    ...
    private static void transformEdge(Map<String, Object> machineJsonObject, List<Object> nodes, Map<String, Object> nodeMap, Map<String, Object> edgeObj) {
        ...
        if (!StringUtils.hasLength(sourceId) || !StringUtils.hasLength(targetId)) {
            throw new RuntimeException("Edge[" + edgeObj.get("id") + "] source or target is nul");
        }
        ...
        if (sourceNode == null || targetNode == null) {
            throw new RuntimeException("The edge[" + edgeObj.get("id") + "] references a non-existent source or target node. Ensure they are properly defined");
        }
