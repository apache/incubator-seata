 ...
 */
public class S1C1Test extends MultiVersionCompatibilityTest {

    // LOG instance
    private static final Logger LOGGER = LoggerFactory.getLogger(S1C1Test.class);
     ...
     */
    @Test
    public void testV1ClientToV1ServerFailure() throws Exception {
        RegisterTMResponse tmResponse = doSendRegister(8232, CodecTestCheckAuthHandler.CODEC_TEST_REG_ERROR);
