...
public class DefaultResourceManager implements ResourceManager {
    ...
    @Override
    public BranchStatus branchCommit(BranchType branchType, FragmentXID xid, long branchId,
    ...
    @Override
    public BranchStatus branchRollback(BranchType branchType, FragmentXID xid, long branchId,
        String resourceId, String applicationData)
        throws TransactionException {
    ...
    public void branchReport(BranchType branchType, String resourceId, FragmentXID xid, long branchId,
        ...
        getResourceManager(branchType).branchReport(branchType, resourceId, xid, branchId, status, applicationData);
    }

    @Override
    public boolean lockQuery(BranchType branchType, String resourceId,
        FragmentXID xid, String lockKeys) throws TransactionException {
