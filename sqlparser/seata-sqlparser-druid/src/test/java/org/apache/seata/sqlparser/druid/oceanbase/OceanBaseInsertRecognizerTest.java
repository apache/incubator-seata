...
public class OceanBaseInsertRecognizerTest {
    ...
    public void testGetSqlType() {
        ...
        OceanBaseInsertRecognizer recognizer = new OceanBaseInsertRecognizer(sql, asts.get(0));
    ...
    public void testGetInsertColumns() {
        ...
        recognizer = new OceanBaseInsertRecognizer(sql, asts.get(0));
    ...
    public void testNotPlaceholder_giveValidPkIndex() {
        ...
        OceanBaseInsertRecognizer oracle = new OceanBaseInsertRecognizer(sql, sqlStatements.get(0));
