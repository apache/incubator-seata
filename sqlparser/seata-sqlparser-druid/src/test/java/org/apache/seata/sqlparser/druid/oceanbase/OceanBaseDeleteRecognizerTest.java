...
import org.apache.seata.sqlparser.druid.oceanbase.OceanBaseDeleteRecognizer;
...
public class OceanBaseDeleteRecognizerTest {

    private static final String DB_TYPE = "oceanbase";
    ...
    public void testGetSqlType() {
        ...
        OceanBaseDeleteRecognizer recognizer = new OceanBaseDeleteRecognizer(sql, asts.get(0));
    ...
    public void testGetWhereCondition_0() {
        ...
        recognizer = new OceanBaseDeleteRecognizer(sql, asts.get(0));
        ...
        Assertions.assertThrows(IllegalArgumentException.class, () -> {
            ...
            new OceanBaseDeleteRecognizer(s, deleteAst).getWhereCondition(new ParametersHolder() {
                @Override
                public Map<Integer,ArrayList<Object>> getParameters() {
                    return new HashMap<>();
                }
    ...
    public void testGetWhereCondition_1() {
        ...
        Assertions.assertThrows(IllegalArgumentException.class, () -> {
            ...
            SQLDeleteStatement deleteAst = (SQLDeleteStatement) sqlStatements.get(0);
            deleteAst.setWhere(new OracleArgumentExpr());
            new OceanBaseDeleteRecognizer(s, deleteAst).getWhereCondition();
        });
    }
}
