 ...
 * @author GoodBoyCoder
 */
public class OracleOperateRecognizerHolderTest {
    @Test
    public void testGetUpdateRecognizer() {
        OracleOperateRecognizerHolder holder = new OracleOperateRecognizerHolder();
        // test with normal
        String sql = "update d.t set d.t.a = ?, d.t.b = ?, d.t.c = ?";
        SQLStatement ast = SQLUtils.parseStatements(sql, JdbcConstants.ORACLE).get(0);
        ...
        SQLStatement ast2 = SQLUtils.parseStatements(sql2, JdbcConstants.ORACLE).get(0);
        ...
        SQLStatement ast3 = SQLUtils.parseStatements(sql3, JdbcConstants.ORACLE).get(0);
