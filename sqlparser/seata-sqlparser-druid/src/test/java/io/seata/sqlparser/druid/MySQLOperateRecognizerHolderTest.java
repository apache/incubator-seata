 ...
 * @author GoodBoyCoder
 */
public class MySQLOperateRecognizerHolderTest {

    @Test
    public void testGetUpdateRecognizer() {
        MySQLOperateRecognizerHolder holder = new MySQLOperateRecognizerHolder();
        // test with normal
        String sql = "update d.t set d.t.a = ?, d.t.b = ?, d.t.c = ?";
        SQLStatement ast = SQLUtils.parseStatements(sql, JdbcConstants.MYSQL).get(0);
        ...
        SQLStatement ast2 = SQLUtils.parseStatements(sql2, JdbcConstants.MYSQL).get(0);
        ...
        SQLStatement ast3 = SQLUtils.parseStatements(sql3, JdbcConstants.MYSQL).get(0);
