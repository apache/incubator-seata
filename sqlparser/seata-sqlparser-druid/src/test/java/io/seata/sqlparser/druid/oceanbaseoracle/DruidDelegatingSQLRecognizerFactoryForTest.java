...
/**
 * A druid sql recognizer delegating factory for test
 *
 * @author hsien999
 */
public class DruidDelegatingSQLRecognizerFactoryForTest extends DruidDelegatingSQLRecognizerFactory {
    private volatile SQLRecognizerFactory recognizerFactoryImpl;

    public DruidDelegatingSQLRecognizerFactoryForTest() {
