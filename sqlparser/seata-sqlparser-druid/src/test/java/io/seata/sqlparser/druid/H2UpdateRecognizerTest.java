...
import io.seata.sqlparser.druid.h2.H2UpdateRecognizer;
...
/**
 * The type h2 sql update recognizer test.
 * @author hongyan 2021-11-12
 */
public class H2UpdateRecognizerTest extends AbstractRecognizerTest {
    ...
    public void updateRecognizerTest_0() {
        ...
        H2UpdateRecognizer H2UpdateRecognizer = new H2UpdateRecognizer(sql, statement);

        Assertions.assertEquals(sql, H2UpdateRecognizer.getOriginalSQL());
        Assertions.assertEquals("t1", H2UpdateRecognizer.getTableName());
        Assertions.assertEquals(1, H2UpdateRecognizer.getUpdateColumns().size());
        Assertions.assertEquals("name", H2UpdateRecognizer.getUpdateColumns().get(0));
        Assertions.assertEquals("name1", H2UpdateRecognizer.getUpdateValues().get(0));
        Assertions.assertEquals("id = 'id1'", H2UpdateRecognizer.getWhereCondition());
    }
    ...
    public void updateRecognizerTest_1() {
        ...
        Assertions.assertEquals(sql, H2UpdateRecognizer.getOriginalSQL());
        Assertions.assertEquals("t1", H2UpdateRecognizer.getTableName());
        Assertions.assertEquals(2, H2UpdateRecognizer.getUpdateColumns().size());
        Assertions.assertEquals("name1", H2UpdateRecognizer.getUpdateColumns().get(0));
        Assertions.assertEquals("name1", H2UpdateRecognizer.getUpdateValues().get(0));
        Assertions.assertEquals("name2", H2UpdateRecognizer.getUpdateColumns().get(1));
        Assertions.assertEquals("name2", H2UpdateRecognizer.getUpdateValues().get(1));
        Assertions.assertEquals("id = 'id1'", H2UpdateRecognizer.getWhereCondition());
    }
    ...
    public void updateRecognizerTest_2() {
        ...
        String whereCondition = H2UpdateRecognizer.getWhereCondition(new ParametersHolder() {
            @Override
    ...
    public void testGetSqlType() {
        ...
        H2UpdateRecognizer recognizer = new H2UpdateRecognizer(sql, asts.get(0));
    ...
    public void testGetUpdateColumns() {
        ...
        recognizer = new H2UpdateRecognizer(sql, asts.get(0));
        ...
        Assertions.assertThrows(SQLParsingException.class, () -> {
            ...
            h2UpdateRecognizer.getUpdateColumns();
        });
    }
    ...
    public void testGetUpdateValues() {
        ...
        Assertions.assertThrows(SQLParsingException.class, () -> {
            ...
            H2UpdateRecognizer h2UpdateRecognizer = new H2UpdateRecognizer(s, sqlUpdateStatement);
            h2UpdateRecognizer.getUpdateValues();
        });
    }
