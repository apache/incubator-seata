 ...
 *
 */
public class OceanBaseInsertRecognizer extends BaseOceanBaseRecognizer implements SQLInsertRecognizer {
     ...
     * @param ast         the ast
     */
    public OceanBaseInsertRecognizer(String originalSQL, SQLStatement ast) {
        super(originalSQL);
