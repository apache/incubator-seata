...
/**
 * The type oceanbase update recognizer.
 *
 */
public class OceanBaseUpdateRecognizer extends BaseOceanBaseRecognizer implements SQLUpdateRecognizer {
     ...
     * @param ast         the ast
     */
    public OceanBaseUpdateRecognizer(String originalSQL, SQLStatement ast) {
        super(originalSQL);
