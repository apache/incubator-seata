...
/**
 * The type oceanbase select for update recognizer.
 *
 */
public class OceanBaseSelectForUpdateRecognizer extends BaseOceanBaseRecognizer implements SQLSelectRecognizer {
     ...
     * @param ast         the ast
     */
    public OceanBaseSelectForUpdateRecognizer(String originalSQL, SQLStatement ast) {
        super(originalSQL);
