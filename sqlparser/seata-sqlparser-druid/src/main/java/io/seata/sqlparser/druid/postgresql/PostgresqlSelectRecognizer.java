 ...
 * @author japsercloud
 */
public class PostgresqlSelectRecognizer extends BasePostgresqlRecognizer implements SQLSelectRecognizer {
     ...
     * @param ast the ast
     */
    public PostgresqlSelectRecognizer(String originalSQL, SQLStatement ast) {
        super(originalSQL);
