...
public class DataBaseLockManagerImplTest {
    ...
    private static void prepareTable(BasicDataSource dataSource) {
        ...
        try {
            ...
            s.execute("CREATE TABLE lock_table ( xid varchar(96) , transaction_id long , branch_id long, resource_id varchar(32) ,table_name varchar(32) ,pk varchar(32) primary key not null  ,  row_key  varchar(128) , status  integer , gmt_create TIMESTAMP(6) ,gmt_modified TIMESTAMP(6)) ");
