package io.seata.server.session.elasticsearch;
...
import io.seata.server.storage.elasticsearch.lock.ElasticSearchLocker;
import io.seata.server.storage.elasticsearch.session.ElasticSearchSessionManager;
...
public class ElasticSearchManagerTest {
    ...
    //private static ElasticSearch = null;

    @BeforeAll
    public static void start() throws IOException {
        ElasticSearchTransactionStoreManager transactionStoreManager = ElasticSearchTransactionStoreManager.getInstance();
        ElasticSearchSessionManager elasticSearchSessionManager = new ElasticSearchSessionManager();
        elasticSearchSessionManager.setTransactionStoreManager(transactionStoreManager);
        sessionManager = elasticSearchSessionManager;
    }
    ...
    public void testReadSessionWithCondition() throws TransactionException {
        ...
        //老问题 找到具体的查询语句 进行刷新 断点调试的时候 由于会断点 所以会拖到elasticsearch自己自动刷新
        //已解决
