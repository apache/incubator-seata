...
public class BranchSession implements Lockable, Comparable<BranchSession>, SessionStorable {
    ...
    public boolean canBeCommittedAsync() {
        // AT, PhaseOne_Failed, AsyncCommit, NoCommit
        return branchType == BranchType.AT
            || status == BranchStatus.PhaseOne_Failed
            || commitType == CommitType.AsyncCommit || commitType == CommitType.NoCommit;
    }
    ...
    public void decode(byte[] a) {
        ...
        try {
            ...
            if (this.branchType != null) {
                // If the `byte[] a` was generated by an older version, set default commitType
                this.commitType = CommitType.getDefault(this.branchType);
            }
        }
    }
