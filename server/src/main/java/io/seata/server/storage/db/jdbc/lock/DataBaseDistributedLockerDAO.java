 ...
 * @author chd
 */
public class DataBaseDistributedLockerDAO implements DistributedLocker {
    private static final Logger LOGGER = LoggerFactory.getLogger(DataBaseDistributedLockerDAO.class);
