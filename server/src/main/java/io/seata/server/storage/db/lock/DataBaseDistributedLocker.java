...
public class DataBaseDistributedLocker implements DistributedLocker {
    ...
    public DataBaseDistributedLocker() {
        ...
        if (StringUtils.isBlank(distributedLockTable)) {
            demotion = true;
            ConfigurationFactory.addConfigListener(DISTRIBUTED_LOCK_DB_TABLE, new ConfigurationChangeListener() {
                @Override
                public void onChangeEvent(ConfigurationChangeEvent event) {
                    ...
                    if (StringUtils.isNotBlank(newValue)) {
                        ...
                        init();
                        demotion = false;
                        ConfigurationFactory.removeConfigListener(DISTRIBUTED_LOCK_DB_TABLE, this);
                    }
                }
            });
