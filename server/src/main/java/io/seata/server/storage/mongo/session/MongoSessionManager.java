 ...
 * @author funkye
 */
@LoadLevel(name = "mongo", scope = Scope.PROTOTYPE)
public class MongoSessionManager extends AbstractSessionManager
    implements SessionManager, SessionLifecycleListener, Initialize, Reloadable {

    /**
     * The constant LOGGER.
     */
    protected static final Logger LOGGER = LoggerFactory.getLogger(MongoSessionManager.class);
     ...
     *            the name
     */
    public MongoSessionManager(String name) {
        super();
        this.taskName = name;
    }
    ...
    @Override
    public void init() {
        transactionStoreManager = MongoTransactionStoreManager.getInstance();
    }
