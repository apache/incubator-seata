...
├── release-seata.xml
└── target
    ├── apache-seata-2.2.0-SNAPSHOT-incubating-bin
    │   ├── DISCLAIMER
    │   ├── LICENSE
    │   ├── NOTICE
    │   ├── seata-namingserver
    ...
    │       │       │   └── apm-seata-skywalking-plugin-2.2.0-SNAPSHOT.jar
    ...
    │       │   ├── seata-discovery-namingserver-2.2.0-SNAPSHOT.jar
    ...
    │       └── target
    │           └── seata-server.jar
    ├── apache-seata-2.2.0-SNAPSHOT-incubating-bin.tar.gz
    ├── apache-seata-2.2.0-SNAPSHOT-incubating-bin.zip
