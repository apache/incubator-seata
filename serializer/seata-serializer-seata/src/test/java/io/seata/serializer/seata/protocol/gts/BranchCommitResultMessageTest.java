...
import io.seata.core.rpc.netty.gts.message.BranchCommitResultMessage;
...
public class BranchCommitResultMessageTest {

    private static short MAGIC = -9510;

    @Test
    public void testBranchCommitResultMessage(){
        BranchCommitResultMessage msg = new BranchCommitResultMessage();
