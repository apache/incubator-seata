...
import io.seata.core.rpc.netty.gts.message.GlobalRollbackMessage;
import io.seata.core.rpc.netty.gts.message.GlobalRollbackResultMessage;
 ...
 * @author cj3
 */
public class GlobalRollbackResultMessageTest {

    private static short MAGIC = -9510;

    @Test
    public void testGlobalRollbackResultMessage(){
        GlobalRollbackResultMessage msg = new GlobalRollbackResultMessage();
        msg.setTranId(0L);
        msg.setResult(1);
