...
public class GlobalRollbackMessageTest {

    private static short MAGIC = -9510;

    @Test
    public void testGlobalRollbackMessage(){
        GlobalRollbackMessage msg = new GlobalRollbackMessage();
        msg.setTranId(347723853L);
        msg.setRealSvrAddr("10.192.140.48");
