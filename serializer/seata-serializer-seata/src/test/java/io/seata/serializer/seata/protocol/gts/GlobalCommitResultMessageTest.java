...
import io.seata.core.rpc.netty.gts.message.GlobalCommitResultMessage;
...
public class GlobalCommitResultMessageTest {
    private static short MAGIC = -9510;

    @Test
    public void testGlobalCommitResultMessage(){
        GlobalCommitResultMessage msg = new GlobalCommitResultMessage();
        msg.setTranId(0L);
        msg.setResult(1);
