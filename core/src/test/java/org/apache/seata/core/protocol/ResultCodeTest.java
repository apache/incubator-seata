...
class ResultCodeTest {
    ...
    void getByte() {
        ...
        Assertions.assertEquals(ResultCode.Retry, ResultCode.get((byte) 2));
    ...
    void getInt() {
        ...
        Assertions.assertEquals(ResultCode.Retry, ResultCode.get(2));
        Assertions.assertThrows(IllegalArgumentException.class, () -> {
            ResultCode.get(3);
        });
    }
    ...
    @Test
    void values() {
        Assertions.assertArrayEquals(new ResultCode[]{ResultCode.Failed, ResultCode.Success,ResultCode.Retry}, ResultCode.values());
    }
