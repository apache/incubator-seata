...
import static io.seata.core.constants.DefaultValues.DEFAULT_LOCK_DB_DEFAULT_TABLE;
...
public class LockStoreDataBaseDAO implements LockStore, Initialize {
    ...
    @Override
    public void init() {
        lockTable = CONFIG.getConfig(ConfigurationKeys.LOCK_DB_TABLE, DEFAULT_LOCK_DB_DEFAULT_TABLE);
