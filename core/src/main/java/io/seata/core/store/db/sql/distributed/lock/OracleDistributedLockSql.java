...
/**
 * oracle版本
 * source BaseDistributedLockSql.java chd* 2021/8/16 11:01 feature: add db realization for distribute lock (#3487)
 * @author opelok-z
 */
public class OracleDistributedLockSql implements DistributedLockSql {
