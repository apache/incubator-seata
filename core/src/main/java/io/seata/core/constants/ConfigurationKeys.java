...
public interface ConfigurationKeys {
    ...
    /**
     * STORE_HBASE_LOCK_KEY_TABLE_PREFIX
     */
    String STORE_HBASE_LOCK_TABLE_PREFIX = STORE_HBASE_TABLE_PREFIX + "lock.";

    /**
     * STORE_HBASE_LOCK_KEY_TABLE_NAME
     */
    String STORE_HBASE_LOCK_TABLE_NAME = STORE_HBASE_LOCK_TABLE_PREFIX + "name";

    /**
     * STORE_HBASE_TABLE_LOCK.
     */
    String STORE_HBASE_LOCK_TABLE_LOCK = STORE_HBASE_LOCK_TABLE_PREFIX + "lockCF";

    /**
     * STORE_HBASE_LOCK_KEY_TABLE_PREFIX
     */
    String STORE_HBASE_LOCK_KEY_TABLE_PREFIX = STORE_HBASE_TABLE_PREFIX + "lockKey.";

    /**
     * STORE_HBASE_LOCK_KEY_TABLE_NAME
     */
    String STORE_HBASE_LOCK_KEY_TABLE_NAME = STORE_HBASE_LOCK_KEY_TABLE_PREFIX + "name";

    /**
     * STORE_HBASE_LOCK_KEY_TABLE_TRANSACTION
     */
    String STORE_HBASE_LOCK_KEY_TABLE_TRANSACTION = STORE_HBASE_LOCK_KEY_TABLE_PREFIX + "transactionIdCF";
