...
public class DefaultValues {
    ...
    public static final int DEFAULT_CLIENT_SELF_CHECK_ALLOW_TIMES = 10;
    ...
    public static final int DEFAULT_CLIENT_SELF_CHECK_PERIOD = 2000;
    ...
    public static final boolean DEFAULT_CLIENT_SELF_CHECK = false;
    /**
