...
public class NettyBaseConfig {
    ...
    static {
        TRANSPORT_PROTOCOL_TYPE = CONFIG.getEnum(ConfigurationKeys.TRANSPORT_TYPE, TransportProtocolType.class, TransportProtocolType.TCP);
        ...
        TRANSPORT_SERVER_TYPE = CONFIG.getEnum(ConfigurationKeys.TRANSPORT_SERVER, TransportServerType.class, TransportServerType.NIO);
