...
-- ----------------------------
ALTER TABLE "UNDO_LOG" ADD CONSTRAINT "SYS_C0020748" PRIMARY KEY ("ID");

-- ----------------------------
-- Uniques structure for table UNDO_LOG
-- ----------------------------
ALTER TABLE "UNDO_LOG" ADD CONSTRAINT "SYS_C0020749" UNIQUE ("XID", "BRANCH_ID") NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;

-- ----------------------------
-- Checks structure for table UNDO_LOG
-- ----------------------------
ALTER TABLE "UNDO_LOG" ADD CONSTRAINT "SYS_C0020747" CHECK ("ID" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
