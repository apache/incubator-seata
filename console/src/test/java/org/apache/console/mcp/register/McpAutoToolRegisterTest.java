 ...
 */
package org.apache.console.mcp.register;
...
import org.apache.seata.mcp.register.McpAutoToolRegister;
...
public class McpAutoToolRegisterTest {
    ...
    public void testRegisterToolWithSimpleTypes() {
        ...
        // verify JSON Schema
        try {
            JsonNode schema = objectMapper.readTree(objectMapper.writeValueAsString(capturedSpec.getTool().getInputSchema()));
    ...
    public static class TestToolWithCollections {
        ...
        public String collectionMethod(
                @ToolParam List<String> list,
                @ToolParam Map<String, Object> map,
                @ToolParam String[] array) {
