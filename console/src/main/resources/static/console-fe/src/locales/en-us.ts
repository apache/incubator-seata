...
const enUs: ILocale = {
  ...
  BusinessDataSource: {
    title: 'Data Source',
    subTitle: 'Business Data Source Management',
    keywordLabel: 'Keyword',
    keywordPlaceholder: 'Search name, resourceId, database or datasource',
    resetButtonLabel: 'Reset',
    searchButtonLabel: 'Query',
    refreshButtonLabel: 'Refresh',
    createButtonLabel: 'Create Data Source',
    createDialogTitle: 'Create Business Data Source',
    ...
    passwordSecretRefLabel: 'Password Secret Ref',
    datasourceLabel: 'Datasource',
    minConnLabel: 'Min Connections',
    maxConnLabel: 'Max Connections',
    maxWaitLabel: 'Max Wait(ms)',
    databaseNameLabel: 'Database',
    enabledLabel: 'Enabled',
    dynamicLabel: 'Dynamic',
    operations: 'Operations',
    deleteLabel: 'Delete',
    staticSourceLabel: 'Static',
    yesLabel: 'Yes',
    noLabel: 'No',
    successLabel: 'Success',
    failedLabel: 'Failed',
    validationRequiredMessage: 'Please enter name, JDBC URL and username',
    passwordRequiredMessage: 'Please enter password or password secret ref',
    createSuccessMessage: 'Data source registered successfully',
    testSuccessMessage: 'Connection test succeeded',
    testFailedMessage: 'Connection test failed',
    deleteTitle: 'Delete data source',
    deleteContent: 'Confirm to delete dynamic data source',
    deleteSuccessMessage: 'Data source deleted successfully',
  },
  codeMessage: {
