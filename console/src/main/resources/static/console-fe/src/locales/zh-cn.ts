...
const zhCn: ILocale = {
  ...
  BusinessDataSource: {
    ...
    subTitle: '业务数据源管理',
    keywordLabel: '关键字',
    keywordPlaceholder: '搜索名称、resourceId、数据库或连接池',
    resetButtonLabel: '重置',
    searchButtonLabel: '查询',
    refreshButtonLabel: '刷新',
    createButtonLabel: '新增数据源',
    createDialogTitle: '新增业务数据源',
    ...
    usernameLabel: '用户名',
    passwordLabel: '密码',
    passwordSecretRefLabel: '密码密钥引用',
    datasourceLabel: '连接池',
    minConnLabel: '最小连接数',
    maxConnLabel: '最大连接数',
    maxWaitLabel: '最大等待时间(ms)',
    databaseNameLabel: '数据库',
    enabledLabel: '启用',
    dynamicLabel: '动态注册',
    operations: '操作',
    deleteLabel: '删除',
    staticSourceLabel: '静态配置',
    yesLabel: '是',
    noLabel: '否',
    successLabel: '成功',
    failedLabel: '失败',
    validationRequiredMessage: '请输入名称、JDBC地址和用户名',
    passwordRequiredMessage: '请输入密码或密码密钥引用',
    createSuccessMessage: '数据源注册成功',
    testSuccessMessage: '连接测试成功',
    testFailedMessage: '连接测试失败',
    deleteTitle: '删除数据源',
    deleteContent: '确认删除动态数据源',
    deleteSuccessMessage: '数据源删除成功',
  },
  codeMessage: {
    200: '服务器成功返回请求的数据。',
    201: '新建或修改数据成功。',
