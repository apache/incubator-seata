...
public class MCPProperties {
    ...
    private ProtocolDefinition.LoggingLevel loggingLevel = ProtocolDefinition.LoggingLevel.INFO;
    ...
    public ProtocolDefinition.LoggingLevel getLoggingLevel() {
        return loggingLevel;
    }

    public void setLoggingLevel(ProtocolDefinition.LoggingLevel loggingLevel) {
