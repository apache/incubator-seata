...
public final class ProtocolDefinition {
    ...
    private static final Logger logger = LoggerFactory.getLogger(ProtocolDefinition.class);
    ...
    public static JSONRPCMessage deserializeJsonRpcMessage(ObjectMapper mapper, String json) throws IOException {
        logger.debug("Received JSON: {}", json);
        HashMap<String, Object> map = mapper.readValue(json, MAP_TYPE_REF);
    ...
    private static JsonSchema parseSchema(String schema) {
        try {
            return MAPPER.readValue(schema, JsonSchema.class);
        } catch (IOException e) {
    ...
    public static class CallToolRequest extends BaseMeta {
        ...
        private static Map<String, Object> parseJsonArguments(String json) {
            try {
