...
public class BranchSessionTools {
    ...
    public String deleteBranchSession(@ToolParam(description = "Global transaction id")String xid,@ToolParam(description = "Branch transaction id")String branchId,@ToolParam(description = "Modify key") String modifyKey){
    ...
    public String forceDeleteBranchSession(@ToolParam(description = "Global transaction id")String xid,@ToolParam(description = "Branch transaction id")String branchId,@ToolParam(description = "Modify key") String modifyKey){
        if (LOGGER.isInfoEnabled()) {
    ...
    public String stopBranchSession(@ToolParam(description = "Global transaction id")String xid,@ToolParam(description = "Branch transaction id")String branchId,@ToolParam(description = "Modify key") String modifyKey){
        if (LOGGER.isInfoEnabled()) {
    ...
    public String startBranchRetry(@ToolParam(description = "Global transaction id")String xid,@ToolParam(description = "Branch transaction id")String branchId,@ToolParam(description = "Modify key") String modifyKey){
        if (LOGGER.isInfoEnabled()) {
