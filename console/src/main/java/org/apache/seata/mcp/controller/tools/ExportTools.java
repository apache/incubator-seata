...
public class ExportTools {
    ...
    public SingleResult<?> exportExcelFromDataWithCustomHeaders(
            @ToolParam(description = "The input data is of type List<Map<String, Object>>",required = true) List<Map<String,Object>> data,
            @ToolParam(description = "Sheet Name",required = true) String sheetName,
            @ToolParam(description = "Where the file is stored", required = true) String filePath,
        ...
        ExcelExportUtil.exportExcelWithCustomHeaders(sheetName,filePath,data,headers);
        return SingleResult.success("Conversion is successful, please check the specified file location: "+filePath);
    }
