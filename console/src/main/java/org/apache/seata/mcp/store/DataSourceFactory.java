...
public class DataSourceFactory {
    ...
    public static DataSource getDataSource(String resourceId) {
        ...
        Map<String, DataSourcesConfiguration.DataSourceProperties> datasources = DataSourcesConfiguration.getDatasources();
    ...
    public static DataSource createDataSource(DataSourcesConfiguration.DataSourceProperties dataSourceProperties,String resourceId) {
        if(dataSourceProperties == null){
