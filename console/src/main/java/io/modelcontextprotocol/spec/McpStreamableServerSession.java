...
public class McpStreamableServerSession implements McpLoggableSession {
	...
	private final static class MethodNotFoundError {
	...
	public final static class McpStreamableServerSessionInit {
		...
		public McpStreamableServerSessionInit(McpStreamableServerSession mcpStreamableServerSession, Mono<McpSchema.InitializeResult> handle) {
