...
public class McpServerFeatures {
	...
	public static class Async {
		...
		public boolean equals(Object o) {
			...
			Async async = (Async) o;
			return Objects.equals(serverInfo, async.serverInfo) && Objects.equals(serverCapabilities, async.serverCapabilities) && Objects.equals(tools, async.tools) && Objects.equals(resources, async.resources) && Objects.equals(resourceTemplates, async.resourceTemplates) && Objects.equals(prompts, async.prompts) && Objects.equals(rootsChangeConsumers, async.rootsChangeConsumers);
		}

		@Override
		public int hashCode() {
			return Objects.hash(serverInfo, serverCapabilities, tools, resources, resourceTemplates, prompts, rootsChangeConsumers);
		}
		...
		public void setRootsChangeConsumers(List<BiFunction<McpAsyncServerExchange, List<McpSchema.Root>, Mono<Void>>> rootsChangeConsumers) {
	...
	public static class Sync {
		...
		public boolean equals(Object o) {
			if (o == null || getClass() != o.getClass()) return false;
			Sync sync = (Sync) o;
			return Objects.equals(serverInfo, sync.serverInfo) && Objects.equals(serverCapabilities, sync.serverCapabilities) && Objects.equals(tools, sync.tools) && Objects.equals(resources, sync.resources) && Objects.equals(resourceTemplates, sync.resourceTemplates) && Objects.equals(prompts, sync.prompts) && Objects.equals(rootsChangeConsumers, sync.rootsChangeConsumers);
		}
	...
	public static class AsyncResourceTemplateSpecification {
		...
		@Override
		public String toString() {
			return "AsyncResourceTemplateSpecification{" +
					"resource=" + resource +
					", readHandler=" + readHandler +
					'}';
		}
		...
		public AsyncResourceTemplateSpecification(McpSchema.ResourceTemplate resource, BiFunction<McpAsyncServerExchange, McpSchema.ReadResourceRequest, Mono<McpSchema.ReadResourceResult>> readHandler) {
			this.resource = resource;
			this.readHandler = readHandler;
		}
	...
	public static class AsyncPromptSpecification {
		...
		public void setPromptHandler(BiFunction<McpAsyncServerExchange, McpSchema.GetPromptRequest, Mono<McpSchema.GetPromptResult>> promptHandler) {
	...
	public static class SyncResourceTemplateSpecification {
		...
		@Override
		public String toString() {
			return "SyncResourceTemplateSpecification{" +
					"resource=" + resource +
					", readHandler=" + readHandler +
					'}';
		}
		...
		public SyncResourceTemplateSpecification(McpSchema.ResourceTemplate resource, BiFunction<McpSyncServerExchange, McpSchema.ReadResourceRequest, McpSchema.ReadResourceResult> readHandler) {
			this.resource = resource;
			this.readHandler = readHandler;
		}
	}
