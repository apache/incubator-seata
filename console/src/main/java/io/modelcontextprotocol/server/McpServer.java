...
public interface McpServer {
    ...
    class AsyncSpecification {
        ...
        private static final McpSchema.Implementation DEFAULT_SERVER_INFO =
                new McpSchema.Implementation("mcp-server", "1.0.0");
         ...
         */
        public AsyncSpecification tool(
                McpSchema.Tool tool,
        ...
        public AsyncSpecification resourceTemplates(
            ...
            for (McpServerFeatures.AsyncResourceTemplateSpecification resource : resourceTemplates) {
                this.resourceTemplates.put(
                        new UriTemplate(resource.getResource().getUriTemplate()), resource);
            }
            return this;
        }
    ...
    class SyncSpecification {
         ...
         * @throws IllegalArgumentException if tool or handler is null
         */
        public SyncSpecification tool(
                McpSchema.Tool tool, BiFunction<McpSyncServerExchange, Map<String, Object>, CallToolResult> handler) {
            Assert.notNull(tool, "Tool must not be null");
            Assert.notNull(handler, "Handler must not be null");
        ...
        public McpSyncServer build() {
            McpServerFeatures.Sync syncFeatures = new McpServerFeatures.Sync(
                    this.serverInfo,
                    this.serverCapabilities,
                    this.tools,
                    this.resources,
