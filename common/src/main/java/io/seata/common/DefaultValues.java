...
public interface DefaultValues {
    ...
    /**
     * the const DEFAULT_ROLLBACK_RETRY_TIMEOUT_UNLOCK_INCLUDE_UNRETRYABLE_ENABLE
     */
    boolean DEFAULT_ROLLBACK_RETRY_TIMEOUT_UNLOCK_INCLUDE_UNRETRYABLE_ENABLE = false;
